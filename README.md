...
Chen Hao Zhang - Implemented the main page with basic functions working. Imeplement Postgresql for history and file sharing. Implemented file sharing feature. Implement OCR model server.
